...
@Component({
  selector: 'app-blog-item-small',
  templateUrl: './blog-item-small.component.html',
  styleUrls: ['./blog-item-small.component.scss']
})
export class BlogItemSmallComponent implements OnInit {
  @Input() news: News;
